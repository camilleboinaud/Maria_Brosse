 ...
 * écoute les évènements clavier avec gestion des préférences. Par défaut, un
 * son est lu à l'activation de la fenêtre, on sort de la fenêtre par ESC et on
 * obtient la règle du jeu par F1, l'aide par F2
 * 
 * @author helene
 * 
 */
public abstract class FenetreAbstraite extends DevintFrameListener {
	...
	protected boolean deuxiemePassage;
	/**
	 * @param title
	 *            : titre de la fenêtre
	 */
	...
	public void keyPressed(KeyEvent e) {
		// gestion de ESC, F1, F3 et F4 dans la classe mère
		// (DevintFrameListener)
		super.keyPressed(e);
	 ...
	 * 
	 * Cette méthode doit être réécrite dans les classes filles si cela n'a pas
	 * de sens pour votre jeu, vous la redéfinissez en la laissant vide
	 **/
