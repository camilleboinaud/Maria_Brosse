...
public abstract class MenuAbstrait extends DevintFrameListener implements
	...
	*/
	...
	public void creerEntete() {
		...
		// le label
		lb1 = new JLabel(nomJeu, SwingConstants.CENTER);
		lb1.setFont(new Font("Calibri", 1, (int)Math.round(100*MainClass.ratioWidth)));
	...
	private void creerOption(String[] noms) {
		...
		// les boutons
		fonteBouton = new Font("Calibri", 1, (int)Math.round(56*MainClass.ratioWidth));
